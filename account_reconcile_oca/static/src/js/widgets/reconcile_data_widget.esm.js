...
/**
 * Odoo 19: `serialized` is not in the web client validFieldTypes whitelist; use `json`
 * so registry validation passes with ?debug=1. The widget is still selected explicitly
 * in views (`widget="account_reconcile_oca_data"`).
 */
